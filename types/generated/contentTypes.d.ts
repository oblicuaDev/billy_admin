...
export interface ApiBillyConfigurationBillyConfiguration
  extends Schema.CollectionType {
  ...
  attributes: {
    tonos: Attribute.Component<'config.tonos'>;
    link_pago: Attribute.String;
    frecuencia_cobros: Attribute.String;
    canal_correo: Attribute.String;
    canal_sms: Attribute.String;
    avatar_billy: Attribute.Media<'images'>;
    cabecera_correo: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    firma_correo: Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    billy_user: Attribute.Relation<
      'api::billy-configuration.billy-configuration',
      'oneToOne',
      'api::billy-user.billy-user'
    >;
    plantilla_correo: Attribute.Blocks;
    link_drive: Attribute.String;
    client_type: Attribute.Boolean & Attribute.DefaultTo<false>;
...
export interface ApiBillyUserBillyUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    billy_configuration: Attribute.Relation<
      'api::billy-user.billy-user',
      'oneToOne',
      'api::billy-configuration.billy-configuration'
    >;
    ...
    plan: Attribute.Relation<
      ...
      'api::plan.plan'
    >;
    auto_recharge: Attribute.Boolean & Attribute.DefaultTo<false>;
...
export interface ApiInvoiceInvoice extends Schema.CollectionType {
  ...
  attributes: {
    ...
    etapa: Attribute.Relation<
      ...
      'api::etapa.etapa'
    >;
    days_outstanding: Attribute.Integer;
    amount: Attribute.Float;
    collection_fees: Attribute.Float;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::billy-configuration.billy-configuration': ApiBillyConfigurationBillyConfiguration;
      'api::billy-user.billy-user': ApiBillyUserBillyUser;
